          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed mb-8">
                To provide accessible, effective, and natural skincare solutions that boost 
                confidence and promote healthy skin habits across Uganda and East Africa.
              </p>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                To become the leading organic skincare brand in East Africa, recognized for 
                our commitment to natural healing, youth empowerment, and community development.
              </p>
            </motion.div>
            ...
            >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <p className="font-semibold text-gray-900 dark:text-white text-lg">UNDP Funded</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">Youth Innovation Program</p>
              </motion.div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Our passionate team of skincare experts and business professionals working 
